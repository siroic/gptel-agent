...
:backend: OpenAI
:model: gpt-5.5
:subagent-models: (:gatherer "DeepSeek/deepseek-v4-flash" :executor "DeepSeek/deepseek-v4-pro" :archive-searcher "DeepSeek/deepseek-v4-flash" :remote-server "DeepSeek/deepseek-v4-pro" :researcher "Claude/claude-sonnet-4-6" :introspector "DeepSeek/deepseek-v4-pro" :researcher-deep "Claude/claude-opus-4-7" :implementer "Claude/claude-opus-4-7" :verifier "DeepSeek/deepseek-v4-pro")
